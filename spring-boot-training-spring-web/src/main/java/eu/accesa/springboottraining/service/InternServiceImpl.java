...
public class InternServiceImpl implements InternService {
    ...
    @Override
    public Optional<InternDto> findInternByNameContaining(String internName) {
        Optional<Intern> byName = internRepository.findInternByNameContainingIgnoreCase(internName);
